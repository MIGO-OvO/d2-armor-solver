...
export const UI_TEXT = {
  'zh-chs': {
    ...
    targetModeHint:'数字徽章：点击设置优先级（①高 ②中 ③低）；= / ≥ / ≤ / ⇔ 徽章：点击切换 精确 / 至少 / 至多 / 区间 约束。设置模糊约束或优先级后，求解器自动分配属性余量。',
  ...
  'zh-cht': {
    ...
    targetModeHint:'數字徽章：點擊設定優先級（①高 ②中 ③低）；= / ≥ / ≤ / ⇔ 徽章：點擊切換 精確 / 至少 / 至多 / 區間 約束。設定模糊約束或優先級後，求解器自動分配數值餘量。',
  ...
  en: {
    ...
    targetModeHint:'Number badge: click to set priority (① high ② mid ③ low). = / ≥ / ≤ / ⇔ badge: click to switch exact / at-least / at-most / range. With fuzzy constraints or priorities, the solver distributes the surplus automatically.',
