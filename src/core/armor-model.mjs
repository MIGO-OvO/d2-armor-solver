...
export const UI_TEXT = {
  'zh-chs': {
    ...
    introUsage:'<ol><li>选择「从零求解」并填写目标六维，或选择「优化现有配装」并填写当前五件。</li><li>可选：在「已有护甲」中导入 DIM CSV 或通过 Bungie 登录读取库存，求解会优先匹配已有件。</li><li>点击求解后，左侧是方案列表，右侧是当前方案的五件明细与刷取计划；结果级动作都在顶部命令栏。</li><li>「已保存方案」在右上角，随时可以载入或删除；保存的方案只存在本机浏览器。</li></ol>',
    helpOpenLabel:'使用说明',
    helpDrawerTitle:'使用说明',
    helpHowToTitle:'使用方式',
    helpDisclaimerTitle:'免责声明',
    helpDisclaimerBody:'<p>本程序完全免费，且不建立任何账号系统。如果你是付费购买的，说明你被骗了。</p><p>目标属性、导入的护甲清单与已保存方案都只保存在当前浏览器／本机，不会上传到项目服务器。在线版仅在你主动登录时通过 Bungie OAuth 读取你自己的库存。</p><p>本程序是第三方工具，与 Bungie 及 DIM 官方无关；命运2相关内容与素材版权归其各自所有者所有。</p>',
    savedBuildsOpenLabel:'已保存方案',
    savedBuildsDrawerTitle:'已保存方案',
    savedBuildsSearchLabel:'搜索方案',
    saveDialogTitle:'保存当前方案',
    saveDialogNameLabel:'方案名称',
    saveDialogCancel:'取消',
    saveDialogConfirm:'保存',
    closeLabel:'关闭窗口',
    upgradeUnlockAll:'全部可替换',
    upgradeLockAll:'全部保留',
    advancedConstraintsTitle:'高级约束',
    advancedConstraintsNone:'未设置',
    dimImportHelpToggle:'如何导入 DIM CSV？',
    calculatorModeLabel:'计算模式', standardModeButton:'从零求解', upgradeModeButton:'优化现有配装',
    upgradeBuildHeading:'优化现有配装',
    upgradeBuildDescription:'默认只显示五件摘要；展开一件即可编辑，切换时自动收起上一件。',
    ...
    targetModeHint:'“优先”决定余量先分配给哪项属性（高 → 中 → 低）；“规则”决定输入值是精确值、下限、上限或区间。点击对应按钮即可切换。',
    ...
    backToTargetsTitle:'返回目标输入',
    conditionsDrawerNote:'需要修改精确 / 至少 / 至多 / 区间 / 优先级或模组数量时，请回到上方“目标六维属性”与碎片区域编辑。',
    openTargetInputsButton:'打开目标与规则输入',
    ...
    footerContent:'<div class="footer-title">命运2 T5配装求解器 · Ver 3.0.1</div><div class="footer-credits"><div class="footer-credit"><span class="footer-role">优化版</span><span>MIGO-OvO</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://github.com/MIGO-OvO" target="_blank" rel="noopener noreferrer">GitHub</a><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/23930138?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer">B站</a><span class="footer-dot" aria-hidden="true">·</span><span>反馈群 1104108070</span></div><div class="footer-credit footer-credit--secondary"><span class="footer-role">原版作者</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/57597346" target="_blank" rel="noopener noreferrer">B站主页</a></div></div>',
  ...
  'zh-cht': {
    ...
    introUsage:'<ol><li>選擇「從零求解」並填寫目標六維，或選擇「最佳化現有配裝」並填寫目前五件。</li><li>選用：在「已有防具」中匯入 DIM CSV 或透過 Bungie 登入讀取庫存，求解會優先符合已有件。</li><li>點擊求解後，左側是方案清單，右側是目前方案的五件明細與取得計畫；結果層級動作都在頂端命令列。</li><li>「已儲存方案」在右上角，隨時可以載入或刪除；儲存的方案只存在本機瀏覽器。</li></ol>',
    helpOpenLabel:'使用說明',
    helpDrawerTitle:'使用說明',
    helpHowToTitle:'使用方式',
    helpDisclaimerTitle:'免責聲明',
    helpDisclaimerBody:'<p>本程式完全免費，且不建立任何帳號系統。如果你是付費購買的，代表你受騙了。</p><p>目標數值、匯入的防具清單與已儲存方案都只保存在目前瀏覽器／本機，不會上傳到專案伺服器。線上版僅在你主動登入時透過 Bungie OAuth 讀取你自己的庫存。</p><p>本程式是第三方工具，與 Bungie 及 DIM 官方無關；天命2相關內容與素材版權歸其各自所有者所有。</p>',
    savedBuildsOpenLabel:'已儲存方案',
    savedBuildsDrawerTitle:'已儲存方案',
    savedBuildsSearchLabel:'搜尋方案',
    saveDialogTitle:'儲存目前方案',
    saveDialogNameLabel:'方案名稱',
    saveDialogCancel:'取消',
    saveDialogConfirm:'儲存',
    closeLabel:'關閉視窗',
    upgradeUnlockAll:'全部可替換',
    upgradeLockAll:'全部保留',
    advancedConstraintsTitle:'進階限制',
    advancedConstraintsNone:'未設定',
    dimImportHelpToggle:'如何匯入 DIM CSV？',
    calculatorModeLabel:'計算模式', standardModeButton:'從零求解', upgradeModeButton:'最佳化現有配裝',
    upgradeBuildHeading:'最佳化現有配裝',
    upgradeBuildDescription:'預設只顯示五件摘要；展開一件即可編輯，切換時自動收起上一件。',
    ...
    backToTargetsTitle:'返回目標輸入',
    conditionsDrawerNote:'需要修改精確 / 至少 / 至多 / 區間 / 優先度或模組數量時，請回到上方「目標六維數值」與碎片區域編輯。',
    openTargetInputsButton:'開啟目標與規則輸入',
    ...
    footerContent:'<div class="footer-title">天命2 T5配裝求解器 · Ver 3.0.1</div><div class="footer-credits"><div class="footer-credit"><span class="footer-role">優化版</span><span>MIGO-OvO</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://github.com/MIGO-OvO" target="_blank" rel="noopener noreferrer">GitHub</a><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/23930138?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer">Bilibili</a><span class="footer-dot" aria-hidden="true">·</span><span>回饋群 1104108070</span></div><div class="footer-credit footer-credit--secondary"><span class="footer-role">原版作者</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/57597346" target="_blank" rel="noopener noreferrer">Bilibili 主頁</a></div></div>',
  ...
  en: {
    ...
    introUsage:'<ol><li>Pick "Build from Scratch" and set your six targets, or "Optimize Current Loadout" and describe your five current pieces.</li><li>Optional: import a DIM CSV or sign in with Bungie under "Owned armor" so plans prefer armor you already have.</li><li>After solving, the left column lists plans and the right column shows the selected plan\'s five pieces and acquisition plan. Result-level actions live in the command bar above.</li><li>"Saved plans" sits in the top-right corner and can be opened at any time; saved plans stay in this browser only.</li></ol>',
    helpOpenLabel:'Help',
    helpDrawerTitle:'Help',
    helpHowToTitle:'How to use',
    helpDisclaimerTitle:'Disclaimer',
    helpDisclaimerBody:'<p>This tool is completely free and has no account system. If you paid for it, you were scammed.</p><p>Your targets, imported armor list, and saved plans stay in this browser or on this device; they are never uploaded to a project server. The online build reads your inventory through Bungie OAuth only when you sign in yourself.</p><p>This is a third-party tool, not affiliated with Bungie or DIM. Destiny 2 content and assets belong to their respective owners.</p>',
    savedBuildsOpenLabel:'Saved plans',
    savedBuildsDrawerTitle:'Saved plans',
    savedBuildsSearchLabel:'Search plans',
    saveDialogTitle:'Save this plan',
    saveDialogNameLabel:'Plan name',
    saveDialogCancel:'Cancel',
    saveDialogConfirm:'Save',
    closeLabel:'Close',
    upgradeUnlockAll:'All replaceable',
    upgradeLockAll:'Keep all',
    advancedConstraintsTitle:'Advanced constraints',
    advancedConstraintsNone:'Not set',
    dimImportHelpToggle:'How do I import a DIM CSV?',
    ...
    upgradeBuildDescription:'Five compact summary rows by default; expand one piece to edit it — opening another closes the previous one.',
    ...
    targetModeHint:'Priority decides which stats receive surplus first (High → Mid → Low). Rule treats the entered value as exact, a minimum, a maximum, or a range. Click either control to cycle it.',
    ...
    backToTargetsTitle:'Back to target inputs',
    conditionsDrawerNote:'To change exact / at-least / at-most / range / priority rules or the mod count, edit the target stats and Fragments above.',
    openTargetInputsButton:'Open target and rule inputs',
    ...
    footerContent:'<div class="footer-title">Destiny 2 T5 Armor Solver · Ver 3.0.1</div><div class="footer-credits"><div class="footer-credit"><span class="footer-role">Optimized edition</span><span>MIGO-OvO</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://github.com/MIGO-OvO" target="_blank" rel="noopener noreferrer">GitHub</a><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/23930138?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer">Bilibili</a><span class="footer-dot" aria-hidden="true">·</span><span>Feedback group 1104108070</span></div><div class="footer-credit footer-credit--secondary"><span class="footer-role">Original author</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/57597346" target="_blank" rel="noopener noreferrer">Bilibili profile</a></div></div>',
...
export const EXOTIC_CLASSES = {
  hunter: {
    ...
    secondary: [
      ...
      ['wormhusk','Spirit of the Wormhusk',['class','health']],
  ...
  warlock: {
    ...
    secondary: [
      ...
      ['starfire','Spirit of Starfire',['grenade','super','weapons']],
      ['swarm','Spirit of the Swarm',['grenade','melee']],
      ['synthoceps','Spirit of Synthoceps',['melee','health','class']],
      ['star-eater','Spirit of the Star-Eater',['super','weapons']],
      ['verity','Spirit of Verity',['grenade','super','melee']],
      ['harmony','Spirit of Harmony',['weapons','super']],
  ...
  titan: {
    ...
    secondary: [
      ['armamentarium','Spirit of the Armamentarium',['grenade','super','weapons']],
      ['alpha-lupi','Spirit of Alpha Lupi',['class','health']],
      ['contact','Spirit of Contact',['melee','health','grenade']],
      ['horn','Spirit of the Horn',['class','grenade']],
