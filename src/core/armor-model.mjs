...
export const UI_TEXT = {
  'zh-chs': {
    ...
    upgradeBuildDescription:'选择每件护甲的框架、第三属性与模组；异域或不想替换的护甲请勾选“固定”。',
  ...
  en: {
    ...
    upgradeBuildDescription:'Choose each piece’s archetype, tertiary stat, and mods; mark Exotics or anything you want to keep as fixed.',
