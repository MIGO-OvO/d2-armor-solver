...
export const UI_TEXT = {
  'zh-chs': {
    ...
    targetModeHint:'“优先”决定余量先分配给哪项属性（高 → 中 → 低）；“规则”决定输入值是精确值、下限、上限或区间。在下拉菜单中直接选择。',
    ...
    footerContent:'<div class="footer-title">命运2 T5配装求解器 · Ver 3.1.3</div><div class="footer-credits"><div class="footer-credit"><span class="footer-role">优化版</span><span>MIGO-OvO</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://github.com/MIGO-OvO" target="_blank" rel="noopener noreferrer">GitHub</a><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/23930138?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer">B站</a><span class="footer-dot" aria-hidden="true">·</span><span>反馈群 1104108070</span></div><div class="footer-credit footer-credit--secondary"><span class="footer-role">原版作者</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/57597346" target="_blank" rel="noopener noreferrer">B站主页</a></div></div>',
  ...
  'zh-cht': {
    ...
    targetModeHint:'「優先」決定餘量先分配給哪項數值（高 → 中 → 低）；「規則」決定輸入值是精確值、下限、上限或區間。在下拉選單中直接選擇。',
    ...
    footerContent:'<div class="footer-title">天命2 T5配裝求解器 · Ver 3.1.3</div><div class="footer-credits"><div class="footer-credit"><span class="footer-role">優化版</span><span>MIGO-OvO</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://github.com/MIGO-OvO" target="_blank" rel="noopener noreferrer">GitHub</a><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/23930138?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer">Bilibili</a><span class="footer-dot" aria-hidden="true">·</span><span>回饋群 1104108070</span></div><div class="footer-credit footer-credit--secondary"><span class="footer-role">原版作者</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/57597346" target="_blank" rel="noopener noreferrer">Bilibili 主頁</a></div></div>',
  ...
  en: {
    ...
    targetModeHint:'Priority decides which stats receive surplus first (High → Mid → Low). Rule treats the entered value as exact, a minimum, a maximum, or a range. Choose directly from each menu.',
    ...
    footerContent:'<div class="footer-title">Destiny 2 T5 Armor Solver · Ver 3.1.3</div><div class="footer-credits"><div class="footer-credit"><span class="footer-role">Optimized edition</span><span>MIGO-OvO</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://github.com/MIGO-OvO" target="_blank" rel="noopener noreferrer">GitHub</a><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/23930138?spm_id_from=333.1007.0.0" target="_blank" rel="noopener noreferrer">Bilibili</a><span class="footer-dot" aria-hidden="true">·</span><span>Feedback group 1104108070</span></div><div class="footer-credit footer-credit--secondary"><span class="footer-role">Original author</span><span class="footer-dot" aria-hidden="true">·</span><a href="https://space.bilibili.com/57597346" target="_blank" rel="noopener noreferrer">Bilibili profile</a></div></div>',
