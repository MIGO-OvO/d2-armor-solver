...
const COPY = Object.freeze({
  "zh-chs": {
    ...
    heroTitle: "把六维目标，变成可执行的配装",
    heroLead: "从理论可达范围到真实库存组合，一次规划生命、近战、手雷、超能、职业与武器六维属性。",
    capabilitiesLabel: "核心能力",
    capabilityOne: "导入 DIM CSV 或通过 Bungie 登录读取库存",
    capabilityTwo: "计算 5 件护甲、套装约束与调整模组",
    ...
    previewTitle: "同一套求解能力，两种运行方式",
    previewDescription: "在线版与离线版使用相同的求解器和 Armor 3.0 规则。门户只负责帮你选择入口。",
    statsLabel: "六维属性",
    statHealth: "生命",
    statMelee: "近战",
    statGrenade: "手雷",
  ...
  "zh-cht": {
    ...
    heroEyebrow: "DESTINY 2 / ARMOR 3.0",
    heroTitle: "把六維目標，變成可執行的配裝",
    heroLead: "從理論可達範圍到真實庫存組合，一次規劃生命、近戰、手榴彈、超能、職業與武器六維數值。",
    capabilitiesLabel: "核心能力",
    capabilityOne: "匯入 DIM CSV 或透過 Bungie 登入讀取庫存",
    capabilityTwo: "計算 5 件防具、套裝限制與調整模組",
    ...
    previewTitle: "同一套求解能力，兩種執行方式",
    previewDescription: "線上版與離線版使用相同的求解器和 Armor 3.0 規則。入口網站只負責協助你選擇路徑。",
    statsLabel: "六維數值",
    statHealth: "生命",
    statMelee: "近戰",
    statGrenade: "手榴彈",
  ...
  en: {
    ...
    heroEyebrow: "DESTINY 2 / ARMOR 3.0",
    heroTitle: "Turn six stat targets into a loadout you can build",
    heroLead: "Move from theoretical reachability to real inventory combinations across Health, Melee, Grenade, Super, Class, and Weapons.",
    ...
    previewTitle: "The same solver, two ways to run it",
    previewDescription: "Online and offline builds use the same solver and Armor 3.0 rules. This portal only helps you choose an entry point.",
    ...
    footerGroup: "QQ group 1050912445",
