...
const COPY = Object.freeze({
  "zh-chs": {
    ...
    offlineTitle: "下载离线版",
    offlineState: "无服务器",
    offlineDescription: "下载 Windows 安装包，安装后从开始菜单启动；需要已安装 WebView2。无需服务器与 CDN，DIM 数据与配装记录 100% 留在本机。",
    downloadRelease: "下载 Windows 离线安装包",
    ...
    stepDownload: "下载 Windows 安装包",
    stepInstall: "双击运行安装程序",
    stepLaunch: "从开始菜单启动",
    footerProduct: "命运2 T5配装求解器",
    footerMaintainer: "维护者 MIGO-OvO",
    footerOriginal: "致谢原版作者 liheng-Huang",
  ...
  "zh-cht": {
    ...
    offlineTitle: "下載離線版",
    offlineState: "無伺服器",
    offlineDescription: "下載 Windows 安裝檔，安裝後從開始功能表啟動；需要已安裝 WebView2。無需伺服器與 CDN，DIM 資料與配裝紀錄 100% 留在本機。",
    downloadRelease: "下載 Windows 離線安裝檔",
    ...
    stepDownload: "下載 Windows 安裝檔",
    stepInstall: "雙擊執行安裝程式",
    stepLaunch: "從開始功能表啟動",
    footerProduct: "天命2 T5配裝求解器",
    footerMaintainer: "維護者 MIGO-OvO",
    footerOriginal: "感謝原版作者 liheng-Huang",
  ...
  en: {
    ...
    offlineDescription: "Download the Windows installer and launch it from the Start menu; WebView2 must already be installed. No server or CDN, and DIM data and saved loadouts stay 100% on your device.",
    downloadRelease: "Download the Windows offline installer",
    ...
    stepDownload: "Download the Windows installer",
    stepInstall: "Run the installer",
    stepLaunch: "Launch it from the Start menu",
    footerProduct: "Destiny 2 T5 Armor Solver",
    footerMaintainer: "Maintained by MIGO-OvO",
    footerOriginal: "Original author credit: liheng-Huang",
