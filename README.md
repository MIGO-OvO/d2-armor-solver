...
[下载桌面离线安装包](https://github.com/MIGO-OvO/d2-armor-solver/releases/latest/download/d2-armor-solver-windows-x64-setup.exe)（x64，约 2.22 MB）。目前通过 DIM CSV 导入库存，桌面版尚未接入 Bungie 登录。原 HTML 离线 ZIP 和网页版继续保留。
